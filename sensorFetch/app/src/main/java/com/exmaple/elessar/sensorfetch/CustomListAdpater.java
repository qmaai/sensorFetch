package com.example.elessar.sensorfetch;
...
public class CustomListAdpater extends SimpleAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            //get the view  holder
            holder=new com.example.lenovo.sensorfetch.ViewHolder();
            ...
            holder=(com.example.lenovo.sensorfetch.ViewHolder) convertView.getTag();
        }
        holder.senso        rName.setText(arrayListwithData.get(position).get("name"));
